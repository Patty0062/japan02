...
const spotGuides = {
    kinshicho: {
        ...
        eat: [
            ...
            "<strong>らーめん一途（一途拉麵／Ramen Ichizu）:</strong> 招牌背脂醬油拉麵湯頭濃郁卻不顯油膩，搭配 Q 彈麵條與厚切叉燒，份量十足且價格實惠，CP 值相當高，用餐時段經常需要排隊。",
            "<strong>立食壽司 根室花まる 錦糸町Termina店:</strong> 店內提供鮭魚、干貝、海膽、甜蝦等新鮮握壽司，以站著吃的方式享受高CP值美味。 ",
            "<strong>喫茶 マウンテン（Café Mountain）:</strong> 店內充滿昭和復古氛圍，除了招牌厚鬆餅外，季節限定水果三明治也深受歡迎，是悠閒享用早餐或早午餐的人氣選擇。",
            "<strong>錦糸町小町食堂（Komachi Shokudo Kinshicho）:</strong> 店內採用自助取餐方式，陳列了多達數十種家常料理與小菜，從烤魚、生魚片、炸物到煮物應有盡有，顧客可以自由組合出喜愛的定食組合。無論是清晨想來碗熱騰騰的白飯與味噌湯，或是宵夜時段想吃點小菜配酒，這裡都能隨時滿足你的胃。",
    ...
    skytree: {
        ...
        eat: [
            ...
            "<strong>六厘舍沾麵 (東京ソラマチ店):</strong> 是東京沾麵界的王者之一，位於晴空城6樓。以超濃郁的豚骨魚介湯頭搭配極粗的 Q 彈麵條聞名，每一口都能吸附滿滿湯汁。 <strong> 營業時間：10:30～23:00 最終點餐22:30",
...
const fullItinerary = [
    ...
    },
    {
        ...
        items: [
            ...
            { time: "06:40 – 07:20", title: "🚊 錦糸町 ➔ 舞濱站", desc: "🚇 JR 總武線轉武藏野線/京葉線約40分鐘", type: "transit", tag: "🚇 電車", map: "https://www.google.com/maps/search/?api=1&query=Maihama+Station", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJv6yrmkAho3RHDJhAJLQoP-i3TkAC1HpTm9AI0Cw-6tEnCtHl494gTEGt&s=10" , guideKey: "godisney" },
            ...
            { time: "08:00 – 20:30", title: "🌋 東京迪士尼海洋 (Tokyo DisneySea)", desc: "夢幻泉鄉、翱翔夢幻奇航與極致夜間秀", type: "anime", tag: "🏰 樂園", map: "https://www.google.com/maps/search/?api=1&query=Tokyo+DisneySea", img: "https://gotravellingworld.com/wp-content/uploads/2025/06/1749475842-2.png" , guideKey: "disney" },
    ...
    },
    {
        ...
        items: [
            { time: "08:00", title: "🏨 從錦糸町出發", desc: "🚶 步行至地鐵站約6分鐘", type: "transit", tag: "🚶 步行", map: "https://maps.app.goo.gl/zr3XCnQcRPxeuKcS6", img: "https://lh3.googleusercontent.com/gps-cs-s/AHRPTWnXmNGPDq4ra47KsINeaPCuT0-zKqyzl_FGB2TcXXgIuy_j9PEgC830obNSeftKUEnxp16rx8W2gA3hsAz69epQfciSRvq5bMVQxHZgM_Qs-QVWlITwewFUIVWHSWOH75vMdI1XNE9QZqwV=w408-h306-k-no", guideKey: "kinshicho" },
    ...
    },
    {
        ...
        items: [
            ...
            { time: "13:45 – 15:00", title: "📍 日本橋–Pokémon center Tokyo DX", desc: "🚶 日本橋高島屋5F ", type: "shop", tag: "🛍️ 購物", map: "https://www.google.com/maps/search/?api=1&query=Nihonbashi", img: "https://www.takashimaya.co.jp/base/pc/store/special/honyaku/img/thumb_nohombashi.jpg" },
